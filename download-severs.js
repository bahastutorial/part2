...
try{$(".bahastutorial-downloadbg").attr("style","background-image: url("+e[0].src+");")}catch(o){$(".bahastutorial-downloadbg").attr("style","background-image: url("+noimg+");")}$("#bahastutorial-download").toggleClass("open")
